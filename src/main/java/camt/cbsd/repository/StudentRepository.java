...
public interface StudentRepository extends CrudRepository <Student,Long> {
    ...
    List<Student> findBySurnameIgnoreCaseContaining(String name);
    List<Student> findBySurnameIgnoreCaseContainingOrSurnameIgnoreCaseContaining(String name,String surname);
}
